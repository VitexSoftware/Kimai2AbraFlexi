# AGENTS.md - Working AI Reference for Kimai2AbraFlexi

## Project Overview
**Type**: PHP Project/Debian Package
**Purpose**: Kimai to AbraFlexi
**Status**: Active
**Repository**: git@github.com:VitexSoftware/Kimai2AbraFlexi.git
...
git clone git@github.com:VitexSoftware/Kimai2AbraFlexi.git
cd Kimai2AbraFlexi
